...
import logging
logger = logging.getLogger('mydownloader_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by MydownloaderWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('MydownloaderWindow')
        new_object = builder.get_object("mydownloader_window")
    ...
    def finish_initializing(self, builder):
        ...
        self.settings = Gio.Settings("net.launchpad.mydownloader")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('mydownloader')
        except ImportError:
            pass
        ...
        try:
            from mydownloader import indicator
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for mydownloader."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for mydownloader."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the MydownloaderWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the MydownloaderWindow is closed."""
